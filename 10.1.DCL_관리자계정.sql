/*
    ...
    >> 시스템 권한 : DB에 접근하는 권한, 객체들을 생성할 수 있는 권한
        * 종류
          ...
          - CREATE SEQIENCE : 시퀀스를 생성할 수 있는 권한
            ...
...
-- 5. SAMPLE 계정에게 TJOEUN계정에서 EMPLOYEE 테이블을 SELECT 할 수 있는 권한
GRANT SELECT ON TJOEUN.EMPLOYEE TO SAMPLE;

-- 6. SAMPLE 계정에게 TJOEUN계정에서 EMPLOYEE 테이블을 INSERT 할 수 있는 권한
...
/*
    ...
    RESOURCE : CREATE TABLE, CREATE SEQUENCE, ... 대다수 포함
    DBA : 시스템 및 객체관리에 대한 모든 권한을 갖고 있는 툴
*/
