...
START WITH 400 INCREMENT BY 5 MAXVALUE 410
NOCYCLE NOCACHE;

/*
    * 시퀀스 사용
        시퀀스명.CURRVAL : 현재 시퀀스의 값(마지막으로 성공하여 수행된 NEXTVAL값)
        시퀀스명.NEXTVAL : 시퀀스값의 일정하게 증가시켜서 발생한 값(다음에 쓰여질 값)
                          현재시퀀스 값에서 INCREMENT BY한 값
                          시퀀스명.CURRVAL + INCREMENT BY
*/
-- 오류 : 시퀀스를 사용한 적이 없기에 오류 발생(최소 한 번 이상의 시퀀스명.NEXTVAL사용후 이용 가능)
...
SELECT SEQ_EMPNO.CURRVAL FROM DUAL; -- 마지막으로 성공한 시퀀스 값이므로 410 출력
...
START WITH 400 NOCACHE;

INSERT INTO EMPLOYEE (EMP_ID, EMP_NAME, EMP_NO, JOB_CODE, HIRE_DATE)
VALUES(SEQ_EID.NEXTVAL, '강감찬', '971001-1234567', 'J3', SYSDATE);

INSERT INTO EMPLOYEE (EMP_ID, EMP_NAME, EMP_NO, JOB_CODE, HIRE_DATE)
VALUES(SEQ_EID.NEXTVAL, '김일이', '9.71001-1234567', 'J3', SYSDATE);
