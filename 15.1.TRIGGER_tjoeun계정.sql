/*
    ...
    (테이블에 이벤트가 발생했을 때) 자동으로 매번 실행할 내용을 미리 정의해 둘 수 있는 객체
    ...
    * 트리거의 종류
     ...
     - SQL문에 의해 영향을 받는 각 행에 따른 분류
      > STATEMENT TRIGGER(문장 트리거)   : 이벤트가 발생되면 딱 한번만 트리거 실행
    ...
    * 트리거의 생성 구문
    ...
    [DECLARE 
        변수 선언;]
    BEGIN
        실행 내용(위의 지정된 이벤트 발생시 자동으로 실행할 구문)
    [EXCEPTION
        예외처리구문;]
    END;
    /
...
*/
SET SERVEROUTPUT ON;
-- EMPLOYEE테이블에서 새로운 행이 INSERT될 때마다 자동으로 메세지 출력
...
INSERT INTO TB_PROSTOCK
VALUES(SEQ_SCODE.NEXTVAL, 200, SYSDATE, 10, 2000000);
INSERT INTO TB_PROSTOCK
VALUES(SEQ_SCODE.NEXTVAL, 201, SYSDATE, 50, 2500000);
...
INSERT INTO TB_PROSALE
VALUES(SEQ_SCODE.NEXTVAL, 201, SYSDATE, 20, 2500000);
...
INSERT INTO TB_PROSALE
VALUES(SEQ_SCODE.NEXTVAL, 200, SYSDATE, 20, 2500000);
...
INSERT INTO TB_PRODETAIL
VALUES(SEQ_DCODE.NEXTVAL, 200, SYSDATE, 30, '출고');