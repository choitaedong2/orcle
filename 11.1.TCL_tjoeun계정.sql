/*
    ...
    * 트랜잭션
     - 데이터베이스의 논리적 연산단위
     - 데이터의 변격사항(DML)들을 하나의 트랜잭션에 묶어서 처리
...
*/
CREATE TABLE EMP_01
AS SELECT EMP_ID, EMP_NAME, JOB_CODE FROM EMPLOYEE;
...
INSERT INTO EMP_01 (EMP_ID, EMP_NAME, JOB_CODE)
    VALUES('302', '홍길동', 'D4');
...
-- DDL문 (CREATE, ALTER, DROP)을 수행하는 순간
-- 기존의 트랜잭션에 있던 변경사항들을 무조건 COMMIT 해줌
CREATE TABLE TEST(
    TID NUMBER
);
